                        ...
                        <?php
                            ...
                            $stmt = $conn->query(
                                "SELECT     
                                    ...
                                    productos.Precio, 
                                    productos.Imagen, 
                                    Categorías.nombre AS CategoriaNombre, -- Se muestra el nombre donde coincide el id.
                                    productos.id 
                                FROM       
                                    productos
                                INNER JOIN 
                                    Categorías -- Coincidencias de categorias con nombres. 
                                ON  -- Inyecta las filas en las que coincidan los id.       
